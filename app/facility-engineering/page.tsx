...
const FINANCE_INVOICE = [150000, 145000, 160000, 155000, 148000, 142000];
const FINANCE_PENALTY = [0, 0, 0, 500, 0, 1841.37];
const FINANCE_2024_INVOICE = [120000, 115000, 130000, 125000, 118000, 112000];
const FINANCE_2024_PENALTY = [0, 0, 0, 200, 0, 500];
const FINANCE_2026_INVOICE = [160000, 158000, 165000, 162000, 170000, 168000];
...
const UNSCHEDULE_CATEGORIES = [
  { key: "breakdown", label: "Breakdown", color: "#ef4444", total: 142, open: 18, wip: 12, completed: 98, cancel: 8, rfCancel: 3, notDoneClosed: 3 },
  { key: "corrective", label: "Corrective", color: "#f97316", total: 185, open: 24, wip: 18, completed: 128, cancel: 10, rfCancel: 2, notDoneClosed: 3 },
  { key: "proactive", label: "Proactive", color: "#3b82f6", total: 64, open: 5, wip: 4, completed: 51, cancel: 3, rfCancel: 1, notDoneClosed: 0 },
  { key: "warranty", label: "Warranty", color: "#8b5cf6", total: 21, open: 3, wip: 2, completed: 14, cancel: 1, rfCancel: 0, notDoneClosed: 1 },
];
...
const SCHEDULE_CATEGORIES = [
  ...
  { key: "scm", label: "SCM", color: "#f97316", total: 63, open: 5, wip: 4, completed: 32, cancel: 3, rfCancel: 1, notDoneClosed: 0 },
];
...
const FEMS_TABS = [
  { key:"general", label:"General" },{ key:"assetStatus", label:"Asset Status" },
  { key:"assetLifespan", label:"Asset Lifespan" },{ key:"assetMaintenance", label:"Asset Maintenance" },
  { key:"assetUptime", label:"Asset Uptime" },{ key:"eodPerformance", label:"EOD Performance" },
